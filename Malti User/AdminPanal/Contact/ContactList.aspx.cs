...
public partial class AdminPanal_Contact_ContactList : System.Web.UI.Page
{
    #region Load Event
    ...
    protected void gvContact_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        if (e.CommandName == "DeleteRecord")
        {
            ...
            {
                DeleteContactList(Convert.ToInt32(e.CommandArgument.ToString().Trim()));
    ...
    #region Delete ContactList
    private void DeleteContactList(SqlInt32 ContactID)
    {
        #region Connection Establish
